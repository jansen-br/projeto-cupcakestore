...
class SSP
{
	 ...
	 */
	static function simple($request, $con, $table, $primaryKey, $columns)
	{
		$bindings = array();
		$db = $con;
	 ...
	 *  @return array          Server-side processing response array
	 */
	static function complex($request, $con, $table, $primaryKey, $columns, $whereResult = null, $whereAll = null)
	{
		$bindings = array();
	...
	static function sql_exec($db, $bindings, $sql = null)
	{
		...
		// Return all
		return $stmt->fetchAll($db::FETCH_BOTH);
	}
